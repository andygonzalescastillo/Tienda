...
import { useSessionsQuery } from '@/user/hooks/useSessionsQuery';
import { useCloseSessionMutation } from '@/user/hooks/useSessionMutations';
...
export const UserSessions = () => {
    ...
    return (
        <div className="min-h-screen bg-background flex flex-col">
            <UserPageHeader
                breadcrumbs={[
                    { label: 'Configuración', to: ROUTES.USER.CONFIGURATION },
